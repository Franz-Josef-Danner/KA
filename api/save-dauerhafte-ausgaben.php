<?php
/**
 * API Endpoint: Save Recurring Expenses (Dauerhafte Ausgaben)
 * 
...
$dataFile = $dataDir . '/dauerhafte-ausgaben.json';
...
if (file_exists($dataFile)) {
    $backupFile = $dataDir . '/dauerhafte-ausgaben.backup.json';
    if (!copy($dataFile, $backupFile)) {
        // Log backup failure but continue with save
        error_log("Warning: Failed to create backup of dauerhafte-ausgaben.json");
    }
}
