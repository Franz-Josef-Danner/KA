<?php
/**
 * API Endpoint: Save Personnel (Personal)
 *
...
$dataFile = $dataDir . '/personal.json';
...
if (file_exists($dataFile)) {
    $backupFile = $dataDir . '/personal.backup.json';
    if (!copy($dataFile, $backupFile)) {
        error_log("Warning: Failed to create backup of personal.json");
    }
}
