<?php
/**
 * API Endpoint: Save Expenses (Ausgaben)
 * 
...
$dataFile = $dataDir . '/ausgaben.json';
...
if (file_exists($dataFile)) {
    $backupFile = $dataDir . '/ausgaben.backup.json';
    if (!copy($dataFile, $backupFile)) {
        // Log backup failure but continue with save
        error_log("Warning: Failed to create backup of ausgaben.json");
    }
}
