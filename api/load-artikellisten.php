<?php
/**
 * API Endpoint: Load Artikellisten (Article Lists)
 * 
 * Returns the article lists data from the JSON file
 * Article lists are keyed by Firmen_ID and reference the company list
 */
...
$dataFile = __DIR__ . '/../data/artikellisten.json';
...
if (!file_exists($dataFile)) {
    ...
    echo json_encode([
        ...
        'message' => 'No data found, returning empty object'
    ]);
    exit;
}
