<?php
/**
 * API Endpoint: Load Recurring Expenses (Dauerhafte Ausgaben)
 * 
 * Returns the recurring expenses data from the JSON file
 */
...
$dataFile = __DIR__ . '/../data/dauerhafte-ausgaben.json';
