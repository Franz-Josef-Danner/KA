<?php
/**
 * API Endpoint: Save Orders (Aufträge)
 * 
...
$dataFile = $dataDir . '/auftraege.json';
...
if (file_exists($dataFile)) {
    $backupFile = $dataDir . '/auftraege.backup.json';
    if (!copy($dataFile, $backupFile)) {
        // Log backup failure but continue with save
        error_log("Warning: Failed to create backup of auftraege.json");
    }
}
