<?php
/**
 * API Endpoint: Save Invoices (Rechnungen)
 * 
...
$dataFile = $dataDir . '/rechnungen.json';
...
if (file_exists($dataFile)) {
    $backupFile = $dataDir . '/rechnungen.backup.json';
    if (!copy($dataFile, $backupFile)) {
        // Log backup failure but continue with save
        error_log("Warning: Failed to create backup of rechnungen.json");
    }
}
